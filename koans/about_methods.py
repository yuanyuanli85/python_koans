...
class AboutMethods(Koan):
    ...
    def test_calling_functions_with_wrong_number_of_arguments(self):
        ...
        self.assertRegex(msg, 'but 3 were given')
    ...
    link_to_overlapped_methhod = another_method_with_the_same_name
    ...
    def test_that_overlapped_method_is_still_there(self):
        self.assertEqual(10, self.link_to_overlapped_methhod())
    ...
    def test_the_documentation_can_be_viewed_with_the_doc_method(self):
        self.assertRegex(self.method_with_documentation.__doc__, 'used for documentation')
