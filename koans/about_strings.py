...
It was the worst of times."
        self.assertEqual(len("It was the best of times,It was the worst of times.")+1, len(string))
...
world!
"""
        num_of_end_of_line = 3
        self.assertEqual(len("Howdy,world!")+num_of_end_of_line, len(string))
        self.assertEqual(len(string.encode()), len(string))
